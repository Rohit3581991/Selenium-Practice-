...
public class ActitimeLoginLogout2 {
	...
	public static void main(String[] args){
		...
		SeleniumUtility.driver.findElement(By.id("username")).sendKeys(SeleniumUtility.getDataFromPropertyFile("rohitsahare9@gmail.com"));
		SeleniumUtility.driver.findElement(By.name("pwd")).sendKeys(SeleniumUtility.getDataFromPropertyFile("D$4EruW6"));
